...
class CommitmentCeremony implements FormTemplate {
	...
	public static function generate() {
		...
		$form->addFields([
			...
			$form->addSection( 'Step Two', 'Initial Ceremony Details', [
				...
				$form->addContent('Please note. Your full name as it appears on the Partnership schedule will be used during the declaratory and contracting vows'),
			]),
			...
			$form->addSection( 'Step Five', 'Exchange of Rings', [
				...
				// TODO: Is this only selecting from their list?
				...
				$form->addConditionalSection( 'registration_office', [
					...
					$form->addRadioConditional( 'Please indicate which music option you would like', 'music_option', [
						$form->addRadioConditionalOption( 'Your own music (specify below)', 'own_music', [
							...
							$form->addText( 'On entrance of', 'music_on_entrance' ),
							$form->addText( 'Whilst signing the certificate', 'music_signing' ),
